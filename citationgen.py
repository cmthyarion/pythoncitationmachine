...
author = input("Please enter an editor, author or compiler name for your source in the format LastName, FirstName: ")
...
print("Now you may copy pasta this text:" + (author) + ". " + (title) + ". " + (date) + ". " + (place) + ", " + (access) + ". ")
